...
import { Dialog, DialogContent, TableContainer, Table, TableHead, TableRow, TableCell, CircularProgress } from "@mui/material"
...
export default function SpecificMap() {
    ...
    if (loading) {
        return <Box sx={{ display: 'flex', justifyContent: 'center', marginTop: 6 }}>
                ...
                return (
                    ...
                    <Box key={key} sx={{ display: 'flex', flexDirection: 'column', gap: 2, alignItems: 'center', marginTop: 4 }}>
                        ...
                        <Box sx={{ display: 'flex', gap: 4 }}>
                            ...
                            <Map layers={layers} center={data.center} />
                        </Box>
